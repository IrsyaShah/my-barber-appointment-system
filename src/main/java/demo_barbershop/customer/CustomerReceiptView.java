...
@WebServlet("/customer/CustomerReceiptView")
public class CustomerReceiptView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (idParam != null) {
			...
			if (receipt != null) {
				...
				request.getRequestDispatcher("/customer/view_receipt.jsp").forward(request, response);
			} else {
