...
The Appointment Management System is a web-based application developed using **Java, JSP and MySQL**, following the **MVC (Model-View-Controller) architecture** and implementing **CRUD operations**.
