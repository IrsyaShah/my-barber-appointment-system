...
The Barbershop Appointment Management System is a web-based application developed using **Java, JSP, Servlet, and MySQL**, following the **MVC (Model-View-Controller) architecture**.
